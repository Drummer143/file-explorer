...
type IconName = 'css' | 'html' | 'folder' | 'draft' | 'minimize' | 'close' | 'fullscreen' | 'fullscreen_exit'
...
function GoogleIcon ({ iconName, className, size, iconParams = { fill: 1, grade: 0, opticalSize: 48, weight: 400 } }: Props) {
    return <span
